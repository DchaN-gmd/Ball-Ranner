...
namespace TimeSystem
{
    public class Timer : MonoBehaviour
    {
        ...
        [SerializeField] private UnityEvent<float> _onUpdateTime;
        #endregion
        ...
        public event UnityAction<float> OnUpdateTime
        {
            add => _onUpdateTime.AddListener(value);
            remove => _onUpdateTime.RemoveListener(value);
        }
        #endregion
